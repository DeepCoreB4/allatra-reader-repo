...
import 'package:advance_pdf_viewer_example/screens/commons/video_list.dart';
import 'package:flutter/material.dart';
    ...
    return YoutubePlayerBuilder(
      ...
      player: YoutubePlayer(
        ...
        onEnded: (data) {
          ...
          _showSnackBar('Nächstes Video gestartet!');
        },
      ),
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Suchen \mit <video id\> oder \<link\>',
                      fillColor: Colors.greenAccent.withAlpha(20),
                      filled: true,
        ...
        onPressed: _isPlayerReady
            ? () {
                if (_idController.text.isNotEmpty) {
                  ...
                  _showSnackBar('Quelle darf nicht leer sein!');
                }
              }
            : null,
